...
function calcInitialLeftPosFloatingPizzas() {
  ...
  var initialLeftPosFloatingPizzas = calcInitialLeftPosFloatingPizzas();
  ...
  var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
      ...
      //moved this three out of for iterration to layout thrashing
      var staticPizza = document.querySelectorAll(".randomPizzaContainer");
      // no need to iterate through all pizzas as they always have the same size..
      ...
      for (var i = 0; i < staticPizza.length; i++) {
        ...
        staticPizza[i].style.width = newwidth;
      }
    }
  ...
  function logAverageFrame(times) { // times is the array of User Timing measurements from updatePositions()
    ...
    // added multiplied by 60, its npt precise but is an indication..
    console.log("Average time to generate last 10 frames: " + sum / 10 + "ms multiplied by 60: " + sum / 10 * 60 + " ms");
  }
  ...
  function updatePositions() {
    ...
    //moved this two to out of for iterations to avoid layout thrashing
    var items = document.querySelectorAll('.mover');
    var pixToTop = document.body.scrollTop;

    for (var i = 0; i < items.length; i++) {
      var phase = Math.sin((pixToTop / 1250) + (i % 5));
      items[i].style.left = initialLeftPosFloatingPizzas[i] + 100 * phase + 'px';
    }
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    for (var i = 0; i < 200; i++) {
      ...
      //not needed any longer as this gets calculated in calcInitialLeftPosFloatingPizzas()
